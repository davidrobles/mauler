...
public class Domineering implements Game<Domineering> {
    ...
    public List<Long> bitMoves() {
        if (bitMoves != null) return bitMoves;
    ...
    private List<Long> bitMoves(long bitBoard, long[] cachedMoves) {
        ...
        for (int i = 0; i < cachedMoves.length; i++)
            if (((bitBoard & cachedMoves[i]) == 0)) bitMoves.add(cachedMoves[i]);

        return bitMoves;
    }

    private void makeMove(long bitMove) {
        if (getCurPlayer() == 0) vBoard |= bitMove;
        else hBoard |= bitMove;
    ...
    public void setBoard(String player, String[] board) {
        ...
        for (int row = 0; row < board.length; row++) {
            ...
            for (int col = 0; col < charArray.length; col++) {
                ...
                if (c == 'v') vBoard |= (1L << index);
                else if (c == 'h') hBoard |= (1L << index);
            }
        }
    }
    ...
    public Optional<GameResult[]> getOutcome() {
        if (getNumMoves() != 0) return Optional.empty();
    ...
    public String toString() {
        ...
        for (int i = 0; i < 64; i++) {
            if ((vBoard & (1L << i)) > 0) builder.append("v");
            else if (((hBoard & (1L << i)) != 0)) builder.append("h");
    ...
    ////        MonteCarlo<net.davidrobles.mauler.domineering.Domineering> mc = new
    // MonteCarlo<net.davidrobles.mauler.domineering.Domineering>(500);
    //        UCT<net.davidrobles.mauler.domineering.Domineering> uct = new
    // UCT<net.davidrobles.mauler.domineering.Domineering>(0.5, 2000);
    //        AlphaBeta<net.davidrobles.mauler.domineering.Domineering> ab = new
    // AlphaBeta<net.davidrobles.mauler.domineering.Domineering>(new TerminalEvaluator());
    //        RandomStrategy<net.davidrobles.mauler.domineering.Domineering> randPlayer = new
    // RandomStrategy<net.davidrobles.mauler.domineering.Domineering>();
    //        List<Strategy<net.davidrobles.mauler.domineering.Domineering>> players = new
    // ArrayList<Strategy<net.davidrobles.mauler.domineering.Domineering>>();
    //        players.add(ab);
    //        players.add(randPlayer);
    //        net.davidrobles.mauler.domineering.Domineering dom = new
    // net.davidrobles.mauler.domineering.Domineering();
    //
    ...
    //    {
    //        net.davidrobles.mauler.domineering.Domineering domineering = new
    // net.davidrobles.mauler.domineering.Domineering();
    ...
    // net.davidrobles.mauler.domineering.Domineering();
    ////        MonteCarlo<net.davidrobles.mauler.domineering.Domineering> mc = new
    // MonteCarlo<net.davidrobles.mauler.domineering.Domineering>(000);
    //        UCT<net.davidrobles.mauler.domineering.Domineering> uct = new
    // UCT<net.davidrobles.mauler.domineering.Domineering>(0.5, 5000);
    //        AlphaBeta<net.davidrobles.mauler.domineering.Domineering> ab = new
    // AlphaBeta<net.davidrobles.mauler.domineering.Domineering>(new TerminalEvaluator());
    //        RandomStrategy<net.davidrobles.mauler.domineering.Domineering> randPlayer = new
    // RandomStrategy<net.davidrobles.mauler.domineering.Domineering>();
