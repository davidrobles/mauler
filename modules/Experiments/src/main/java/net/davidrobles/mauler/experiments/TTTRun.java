...
public class TTTRun {
    ...
    static final Strategy<TicTacToe> uctRootP =
            new MCTSRootParallel<TicTacToe>(new UCT<TicTacToe>(Math.sqrt(2), 1000));
    ...
    // */);
    //  static final Strategy<TicTacToe> epsilonGreedy = new EpsilonGreedyStrategy<TicTacToe>(/*
    // heuristic */, 0.1);
    ...
    //  static final Strategy<TicTacToe> uctNoRollout = new UCTNoRollout<TicTacToe>(Math.sqrt(2), /*
    // heuristic */);
