...
public class NTSLearning {
    // TODO: What about a learner that tests the learning after n number of time steps against some
    // particular player?
    ...
    static void learnNTSWithTD0PlayingAgainstSelf() {
        ...
        //        NTupleSystem nts = new
        // NTupleSystem(NTUtil.createNTuples(LogistelloPatterns.PATTERNS));
        //        nts.reset();
