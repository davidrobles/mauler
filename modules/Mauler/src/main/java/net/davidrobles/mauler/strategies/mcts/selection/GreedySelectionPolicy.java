...
/**
 * A purely greedy selection policy: always descends into the child with the highest mean value
 * Q(s,a), with no exploration bonus.
 *
 * <p>Equivalent to {@link UCB1} with c&nbsp;=&nbsp;0. Useful as a baseline and in contexts where
 * the tree is already well-explored, but tends to under-explore and converge prematurely in
 * practice.
 *
 * <p>Any unvisited arm is treated as having infinite value, and one is chosen uniformly at random
 * among them via reservoir sampling.
 *
 * <p>References:
 *
 * <ul>
 *   <li>Browne et al. (2012). "A Survey of Monte Carlo Tree Search Methods." <em>IEEE TCIAIG</em>,
 *       4(1):1&ndash;43. §3.2 discusses the exploration constant and notes that c&nbsp;=&nbsp;0
 *       reduces UCT to pure exploitation.
 * </ul>
 */
