...
/** Games that implement this interface accept listeners. These listeners and registers */
public interface MoveObservable {
    ...
    /** Notifies the registered listeners of changes in the state of the game (i.e. move made). */
