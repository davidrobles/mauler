...
/**
 * A selection policy chooses which child to descend into during the tree traversal phase of MCTS.
 * Scores are always from the perspective of the current player at the node, so the policy always
 * maximizes.
 */
