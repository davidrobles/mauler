 ...
 *
 * <p>Specializes {@link MCTSWithPrior} with UCB1 as the selection policy. Constructors without a
 * {@code rolloutPolicy} argument use {@link RandomStrategy} as the default.
 *
...
public class UCTWithPrior<GAME extends Game<GAME>> extends MCTSWithPrior<GAME> {
     ...
     */
    public UCTWithPrior(
            Strategy<GAME> rolloutPolicy, double c, Evaluator<GAME> priorEF, int initQVisits) {
