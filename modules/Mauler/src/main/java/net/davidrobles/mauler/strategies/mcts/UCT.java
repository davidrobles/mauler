 ...
 *
 * <p>Specialises {@link MCTS} with the {@link UCB1} tree policy and a uniformly random rollout
 * policy. Constructors without a {@code rolloutPolicy} argument use {@link RandomStrategy} as the
 * default rollout policy.
 *
 * <p>Two operational modes are supported:
 *
 * <ul>
 *   <li>Simulation-count — pass {@code nSims}; {@link #move(Game)} runs exactly that many
 *       simulations.
 *   <li>Time-based — omit {@code nSims}; use {@link #move(Game, int)} with a millisecond budget.
 * </ul>
 */
