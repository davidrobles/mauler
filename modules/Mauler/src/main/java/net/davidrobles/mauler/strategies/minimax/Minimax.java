 ...
 *
 * <p>Explores the game tree up to {@code maxDepth} plies and evaluates leaf nodes with the supplied
 * {@link Evaluator}. At each node the current player maximizes their score; the opponent minimizes
 * it.
 *
 * <p>When constructed without an explicit depth limit the search runs to terminal positions. Use
 * {@link AlphaBeta} for better performance — it produces identical results with far fewer node
 * evaluations.
 *
