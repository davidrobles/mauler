...
public class GWRun {
    ...
    //        GWVView view = new GWVView(mdp, 4, 4, null, env);
    //        new DRFrame(view);
    //        VValuesAlgorithm<GWState, GWAction> algorithm = new DPPolicyIteration<GWState,
    // GWAction>(mdp, alpha, gamma, RNG);
    //        algorithm.addVFunctionObserver(view);
    ...
    //                new RandomPolicy<GWState, GWAction>(new ActionsFunction<GWState,
    // GWAction>(mdp), RNG);
    //        GWVView view = new GWVView(mdp, 30, 30, null, env);
    //        view.setShowCurrentState(true);
    //        new DRFrame(view);
    //        VValuesAlgorithm<GWState, GWAction> algorithm = new FirstVisitMC<GWState,
    // GWAction>(env, policy, 500);
    //        algorithm.addVFunctionObserver(view);
    //        algorithm.run();
    ////        System.out.println("Optimal policy found.");
    ////        play(mdp, policy, view);
    ...
    //        new DRFrame(view);
    //        PolicyIteration<GWState, GWAction> learner = new PolicyIteration<GWState,
    // GWAction>(mdp, theta, gamma);
    ...
    //        GWVView view = new GWVView(mdp, 20, 20, env);
    //        new DRFrame(view);
    //        ValueIteration<GWState, GWAction> learner = new ValueIteration<GWState, GWAction>(mdp,
    // alpha, gamma);
    //        learner.addVFunctionObserver(view);
    //        learner.learn();
    //    }
    ...
    private static void TabularTD0() {
        ...
        TabularTD0<GWState, GWAction> learner =
                new TabularTD0<>(env, policy, alpha, gamma, numEpisodes);
        learner.addVFunctionObserver(view);
        learner.learn();
    }
    ...
    //        TabularTDLambda<GWState, GWAction> learner = new TabularTDLambda<GWState,
    // GWAction>(env, policy, alpha,
    ...
    private static void TabularSARSA0() {
        ...
        TabularSARSA<GWState, GWAction> learner =
                new TabularSARSA<>(env, policy, alpha, gamma, numEpisodes);
    ...
    //        QLearning<GWState, GWAction> learner = new QLearning<GWState, GWAction>(env, policy,
    // alpha, gamma, numEpisodes);
    //        learner.addQFunctionObserver(view);
    //        learner.learn();
    //    }
    //
    private static void TabularSARSALambda() {
        ...
        TabularSARSALambda<GWState, GWAction> learner =
                new TabularSARSALambda<GWState, GWAction>(
                        env, policy, alpha, gamma, lambda, numEpisodes);
        learner.addQFunctionObserver(view);
        learner.learn();
    }
