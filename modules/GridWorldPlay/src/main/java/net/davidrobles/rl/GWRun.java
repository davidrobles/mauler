...
public class GWRun {
    ...
    private static void TabularTD0() {
        ...
        TabularTD0<GWState, GWAction> learner =
                new TabularTD0<GWState, GWAction>(env, policy, alpha, gamma, numEpisodes);
        learner.addVFunctionObserver(view);
        learner.learn();
    }
    ...
    private static void TabularTDLambda() {
        ...
        TabularTDLambda<GWState, GWAction> learner =
                new TabularTDLambda<GWState, GWAction>(
    ...
    private static void TabularSARSA0() {
        ...
        TabularSARSA<GWState, GWAction> learner =
                new TabularSARSA<GWState, GWAction>(env, policy, alpha, gamma, numEpisodes);
    ...
    private static void TabularQLearning() {
        ...
        QLearning<GWState, GWAction> learner =
                new QLearning<GWState, GWAction>(env, policy, alpha, gamma, numEpisodes);
        learner.addQFunctionObserver(view);
        learner.learn();
    }
